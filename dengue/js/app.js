 ...
 (function($) {
  ...
  $('#id_ogess').on('change', function(){
          if($('#id_ogess').val() == ""){
            ...
            $('<option value = "">Debe seleccionar una UGIPRESS antes</option>').appendTo('#id_red');
            $('<option value = "">Debe seleccionar una red de salud antes</option>').appendTo('#id_mred');
            $('<option value = "">Debe seleccionar una micro red de salud antes</option>').appendTo('#id_establecimiento');
            $('#id_red').attr('disabled', 'disabled');
            $('#id_mred').attr('disabled', 'disabled');
            $('#id_establecimiento').attr('disabled', 'disabled');
          }else{
  ...
  $('#id_red').on('change', function(){
     if($('#id_red').val() == ""){
            $('#id_mred').empty();
            $('<option value = "">Debe seleccionar una red antes</option>').appendTo('#id_mred');
            $('#id_mred').attr('disabled', 'disabled');
          }else{
  ...
  $('#id_mred').on('change', function(){
     if($('#id_mred').val() == ""){
            $('#id_establecimiento').empty();
            $('<option value = "">Debe seleccionar una Micro red antes</option>').appendTo('#id_establecimiento');
            $('#id_establecimiento').attr('disabled', 'disabled');
          }else{
          
            $('#id_establecimiento').removeAttr('disabled', 'disabled');
            $('#id_establecimiento').load('modelos/combo_establecimiento.php?id_mred=' + $('#id_mred').val());
          }
    }); 
  ...
  $('#tipo_regimen').on('change', function(){
     if($('#tipo_regimen').val() == ""){
            $('#tipo_seguro').empty();
            $('<option value = "">Debe seleccionar un tipo de regimen</option>').appendTo('#tipo_seguro');
            $('#tipo_seguro').attr('disabled', 'disabled');
          }else{
          
            $('#tipo_seguro').removeAttr('disabled', 'disabled');
            $('#tipo_seguro').load('modelos/combo_tiposeguro.php?id_tipo_regimen=' + $('#tipo_regimen').val());
          }
    }); 
   ...
   $('#manejo_falle').on('change', function(){
     if($('#manejo_falle').val() == ""){
            ...
            $('<option value = "">Debe seleccionar el manejo del fallecido</option>').appendTo('#orden_cremacion');
            $('#orden_cremacion').attr('disabled', 'disabled');
          }else{
          
            $('#orden_cremacion').removeAttr('disabled', 'disabled');
            $('#orden_cremacion').load('modelos/combo_orden_cremacion.php?id_man_falle=' + $('#manejo_falle').val());
          }
    }); 
     ...
     $('#id_departamento').on('change', function(){
          if($('#id_departamento').val() == ""){
            $('#id_provincia').empty();
            $('#id_distrito').empty();
            $('<option value = "">Debe seleccionar un departamento</option>').appendTo('#id_provincia');
            $('<option value = "">Debe seleccionar una provincia</option>').appendTo('#id_distrito');
            $('#id_provincia').attr('disabled', 'disabled');
            $('#id_distrito').attr('disabled', 'disabled');
            }else{
            $('#id_provincia').removeAttr('disabled', 'disabled');
            $('#id_provincia').load('modelos/combo_provincia.php?id_departamento=' + $('#id_departamento').val());
          }
    });
  ...
  $('#id_provincia').on('change', function(){
     if($('#id_provincia').val() == ""){
            ...
            $('#id_distrito').load('modelos/combo_distrito.php?id_provincia=' + $('#id_provincia').val());
          }
    }); 
