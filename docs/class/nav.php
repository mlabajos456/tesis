        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
              ...
              <ul class="nav">
                          ...
                          <div id="submenu-1" class="collapse " style="">
                                ...
                                <ul class="nav flex-column sub-menu">
                                      ...
                                      <li class="nav-item">
                                            ...
                                            <a class="nav-link" href="<?php echo $nav; ?>covid">Casos de Dengue</a>
                    ...
                    <li class="nav-item ">
                          ...
                          <a class="nav-link" href="#submenu-2" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-tags menu-icon"></i> <span class="menu-title">&nbsp;&nbsp;Administrar Usuario</span> </a>
