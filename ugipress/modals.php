        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Codigo de UGIPRESS" name="cod_ref" id="cod_ref" aria-label="cod_ref" aria-describedby="colored-addon1">
            </div>
          </div>
          <div class="form-group ">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Nombre de UGIPRESS" name="descripcion" id="descripcion" aria-label="nom_ugipress" aria-describedby="colored-addon1">
            </div>
          </div>
  ...
  <div class="modal fade" id="dataUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog " role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="datos_ajax_register"></div>
          <input type="hidden" class="form-control" id="codigo_ugipress2" name="codigo_ugipress2" required="required">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="number" class="form-control" placeholder="Codigo de referencia" name="cod_ref2" id="cod_ref2" aria-label="cod_ref" aria-describedby="colored-addon1">
            </div>
          </div>
          <div class="form-group ">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Nombre de UGIPRESS" name="descripcion2" id="descripcion2" aria-label="nom_ugipress" aria-describedby="colored-addon1">
            </div>
          </div>
