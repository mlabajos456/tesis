   ...
   class PDF extends FPDF
	{
		 ...
		 function Header()
		{
         //  $id=$_GET['codigo'];
            ...
            $this->Image('../docs/images/rioja.png',10,6,22,13 );
        ...
        function cabeza($titulo,$x,$y,$reg){
           ...
           // $this->Cell(0,10, 'Fuente: IA Test Vocacional 2018' ,0,0,'R' );
            ...
            $this->SetXY(35,$y);
            $this->SetFont('Helvetica', 'B',10);
            $this->Cell(35,5,"Municipalidad Distrital de Rioja", 0, 0, 'L', 0);
            $this->SetXY(35,$y=$y+4);
            $this->Cell(35,5,"ruc: 20148170933", 0, 0, 'L', 0);
            $this->SetXY(35,$y=$y+4);
            $this->SetFont('Helvetica', '',9);
            $this->Cell(35,5,"PLANILLA DE PAGO", 0, 0, 'L', 0);
            $this->SetXY(85,$y);
            $this->SetFont('Helvetica', 'B',10);
            $this->Cell(35,5,"BOLETA DE PAGO", 0, 0, 'L', 0);
            $this->Cell(30);
            $this->Ln(30);
       ...
       function drawRows($w, $h, $txt, $border=0, $align='J', $fill=false, $maxline=0, $prn=0)
        ...
        $texto="1. Horario de los almacenes: Lunes- de Sábado 7:30 a.m. a  12:30 p.m de 3.00p.m.a 6.00 p.m. La recepción de productos Orgánicos y convencionales es de Lunes a sábado de 7.30 am a 12.30 pm. de 3.00 a 6.00 p.m.\n
        2.Si está comercializando con CACAO EL REY INDUSTRIAS SAC Algún tipo Producto Orgánico, esta debe cumplir con las regulaciones y disposiciones de la normativa orgánica establecidas en el Reglamento Técnico para productos orgánicos EU, NOP, JAS. PER D.S.No.0044-2016-AG.                                                                            
     ...
     function cabeceraVertical($cabecera,$x,$y,$w,$h,$font,$style,$size,$align)
    {
        ...
        foreach($cabecera as $columna)
        {
            ...
            $this->Cell($w,$h, utf8_decode($columna),0, 2 , $align,1 );
        }
    }
    ...
    function datosVerticales($datos,$x,$y,$w,$h,$font,$style,$size,$align)
    {
        ...
        {
            $this->Cell($w,$h, utf8_decode($columna),0, 2 , $align );
        }
    }
